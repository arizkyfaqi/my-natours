      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51Gug3pFI9GaILRUByUGQwWg4ryXkxlfEi42kSRXv0rKgtgfOQjlveGN2BbitbJexHuhtSdEruBtoSbzU1jRB2piM00tXgqsUkG');
            _context.next = 4;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJmYWRldiIsImEiOiJja2IzcHpwNjcwNW14MnlwdGpzcGtuMjU1In0.l6bSQQWsSP0gr5HmSf2Wrg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/arfadev/ckb3r54xw0u661is7yw3sn43e',
    scrollZoom: false // center: [-118.122119, 34.12034],
    // zoom: 7
    // interactive: false
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var currentPass, newPassword, newPasswordConfrim;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newPasswordConfrim = document.getElementById('password-confirm').value;
            _context.next = 7;
            return (0, _updateSettings.updateSettings)({
              currentPass: currentPass,
              newPassword: newPassword,
              newPasswordConfrim: newPasswordConfrim
            }, 'password');
